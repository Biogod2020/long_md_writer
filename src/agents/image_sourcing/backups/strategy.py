...
Provide a single, short sentence of guidance for selecting the best image (e.g., "The image should clearly illustrate the specified concepts within the provided context.").
