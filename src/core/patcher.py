...
def apply_smart_patch(content: str, search_block: str, replace_block: str) -> Tuple[str, bool]:
    ...
    # SOTA: Return a detailed error for feedback loops
    return f"PATCH_FAILED: Search block not found in the target content. Similarity score was too low or block is missing. Search block snippet: {search_block[:100]}...", False
